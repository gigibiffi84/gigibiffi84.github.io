...
lang: en
translationKey: "chocolatey-package-manager"
headerImage: "/images/chocolatey-package-manager/header.jpg"
---
...
I can say at all that after i installed and tried [**Chocolatey**](https://chocolatey.org/) i was satisfied by this tool. This package manager is great, it is possible to install it with one instruction from command line. I used Chocolatey to automate the installation of my development environment. Usually i need the same set of tools and libraries, so it was helpful enough to instruct Chocolatey to the installation of all my needed packages.
...
```
So, if everything went well, Chocolatey was installed in your system and now you can use the ***choco*** command from any point in the shell. With the command *choco * you can install all the [packages](https://chocolatey.org/packages) available on the Chocolatey repositories.
...
However [here](https://github.com/chocolatey/choco/wiki/CommandsReference) you can find the Commands Reference Documentation for all choco options and switches.

I think that's all for us, i'd like to continue saying many other things about this tool, but if you are interested to master Chocolatey you can refer to the Chocolatey [wiki](https://github.com/chocolatey/choco/wiki) that provides all tricks and explanations about this package manager.
