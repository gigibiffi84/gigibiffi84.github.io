...
```
Se tutto è andato a buon fine, Chocolatey è stato installato sul vostro sistema e il comando ***choco*** dovrebbe essere richiamabile da qualsiasi punto della shell. Con il comando *choco * potete installare tutti i [pacchetti](https://chocolatey.org/packages) disponibili sui repository di Chocolatey. Ad esempio per installare Java8, Python e Git sul mio sistema mi è bastato dare in sequenza questi tre comandi:
...
Il comando choco offre tutte le [opzioni](https://github.com/chocolatey/choco/wiki/CommandsReference) normalmente offerte da tutti i package manager per cercare i pacchetti, installarli, disinstallarli e aggiornarli.
...
che si preoccupa di aggiornare tutti i vostri pacchetti senza bisogno di fare nulla. Dopo aver condiviso con voi le basi di questo fantastico strumento, se siete interessati a smanettare con Chocolatey vi lascio il [link](https://github.com/chocolatey/choco/wiki) della documentazione. Buone installazioni a tutti :)
