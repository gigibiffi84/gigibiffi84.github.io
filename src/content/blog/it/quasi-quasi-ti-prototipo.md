...
#### Solo per prototipi?
Non credo che App.js si possa considerare un vero e proprio framework, e non è adatto per sviluppare applicazioni scalabili.  E' sicuramente un ottimo strumento per ottenere per dare una struttura semplice alle vostre applicazioni mobile. Utilizzato insieme ad altri framework come AngularJs o VueJs e jQuery oppure Zepto si può andare oltre lo sviluppo di semplici prototipi diventando molto utile per sviluppare applicazioni più complesse con una base davvero semplice. Intanto ho terminato il mio [prototipo](http://www.luigibifulco.it/proto_app/), nel prossimo articolo vi darò più dettagli sul risultato dei test che andrò a fare su Geolocation e Application Cache. Nel frattempo potete dare un'occhiata al codice che ho pubblicato su [github](https://github.com/muten84/html5-offline-geolocation-app)
